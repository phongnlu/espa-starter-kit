...
(function () {
	...
	var TodoApp = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			var router = Router({
				'/react': setState.bind(this, { nowShowing: app.ALL_TODOS }),
				'/react/active': setState.bind(this, { nowShowing: app.ACTIVE_TODOS }),
				'/react/completed': setState.bind(this, { nowShowing: app.COMPLETED_TODOS })
			});
			router.init('/react');
		},
	...
	if (window.ESPA) {
		window.ESPA.on('/espa/apps/react/bootstrap', function() {
			console.log('/espa/apps/react/bootstrap callback');
			let container = document.getElementById('react');
	  	container.innerHTML = '<section class="todoapp"></section>';    
			render();
		});
	} else {
		render();
